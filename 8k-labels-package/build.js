...
const CSS = '<style>'
 ...
 + '#labelEditor .le-size input{width:76px;height:38px;border:2px solid #000;border-radius:0;text-align:center;font-size:14px;padding:0 6px;color:#000;background:#ede3d6}'
 ...
 + '.__theme__{}' + ':root{--cream:#ede3d6;--cream-dark:#ddd0bd;--ink:#000000;--ink-soft:#000000;' + '--olive:#000000;--olive-dark:#000000;--olive-light:#000000;--wine:#000000;' + '--line:#000000;--divider:#000000;--white:#ede3d6;--radius:0;}' + 'body{background:#ede3d6;color:#000;font-family:\'Special Elite\',\'Courier New\',monospace;text-transform:lowercase;}' + 'h1,h2,h3,h4,.section-head h2,.tab-btn,.preview-btn,.pay-btn,.eng-regen,.topnav a,.logo .word,.logo .mark,.eyebrow,.hero h1{text-transform:uppercase;}' + 'input,select,textarea,button{font-family:\'Special Elite\',\'Courier New\',monospace;color:#000;}' + 'input,select,textarea{background:#ede3d6;border:2px solid #000;border-radius:0;}' + '::placeholder{color:#000;opacity:1;}' + '.preview-btn,.pay-btn,.eng-regen{background:#000;color:#ede3d6;border:2px solid #000;border-radius:0;}' + '.preview-btn:hover,.pay-btn:hover,.eng-regen:hover{background:#2b2b2b;color:#ede3d6;}' + '.preview-btn.stale{background:#d6c8b4 !important;color:#000;}' + '.dash-sep{border-top:2px solid #000;margin:26px 0 22px;}' + '.preview-loader{background:#ede3d6;}' + '.preview-loader .ld-fact{color:#000;font-family:\'Special Elite\',\'Courier New\',monospace;}' + '.tab-btn{background:#ddd0bd;color:#000;}.tab-btn:hover{background:#d3c4ae;}' + '.tab-btn.active{background:#ede3d6;color:#000;}' + '.tabbar.over-cover, .tabbar.over-cover .tab-btn{background:#ede3d6;}' + '.hero-scrim{background:transparent;}.hero,.hero h1,.hero p{color:#000;}' + '.hero-note{color:#000;}' + 'footer{background:#000;color:#ede3d6;}footer a{color:#ede3d6;}' + 'textarea{color:#000;}.word-count,.brief-intro{color:#000;}' + '.dot-input{accent-color:#000;}' + '#labelEditor .le2-stage{background:#ffffff;border:2px solid #000;}' + '#frontThumbs .eng-optlab{color:#000;}.eng-dl{color:#000;}' + '#engRegenSep{margin:30px 0 0;}' + '#panel-front .pricing{margin-top:23px;}' + '#backThumbs .thumb-box,#backReveal .thumb-box{border:none;box-shadow:none;background:transparent;}' + '#labelEditor .le2-box.grp[data-zfid=alcVol]{justify-content:space-between;}' + '.le2-avgrp{display:inline-flex;align-items:center;gap:.45em;white-space:nowrap;}' + '#labelEditor .le2-lbl,#labelEditor .le2-inp,#labelEditor .le2-vinp,#labelEditor .le2-sel{text-transform:none;}' + '#labelEditor .le2-box.a-left,#labelEditor .le2-box.a-right,#labelEditor .le2-box.a-center{justify-content:center;}' + '#labelEditor .le2-box.a-left .le2-inp,#labelEditor .le2-box.a-right .le2-inp{text-align:center;}' + '.topbar{border-bottom:2px solid #000;padding-left:max(40px,calc((100vw - 1180px)/2 + 40px));padding-right:max(40px,calc((100vw - 1180px)/2 + 40px));}' + '.le-unit,.le-sizelab{color:#000;}' + '.hero{aspect-ratio:2075/758;min-height:0;height:auto;}' + '.hero-photo{object-fit:cover;object-position:center;}'
 + '</style>';

...
function buildBrief(){var sd=EightKImageGen.seed||0;
  return {vision:visionText(),reference:window.__LABEL_REF__||null,data:data(),seed:sd,
  zones:(window.LabelEngine&&window.LabelEngine.styleZones)?window.LabelEngine.styleZones(sd):null,
  aspect:labelAspect()};}

...
export interface StoredLabel { id: string; style: string; widthMm: number; heightMm: number; faces: string; ground: string; createdAt: string; fit?: "yield" | "crop" | "top" | "vignette"; template?: string; hasPaper?: boolean; artist?: string; refSet?: string }

export function saveLabel(l: { style: string; widthMm: number; heightMm: number; faces: string; ground: string; svg: string; png: string; art: string; prompt: string; layout: Layout; fit?: "yield" | "crop" | "top" | "vignette"; template?: string; hasPaper?: boolean; artist?: string; refSet?: string }): string {
  ...
  const meta: StoredLabel = { id, style: l.style, widthMm: l.widthMm, heightMm: l.heightMm, faces: l.faces, ground: l.ground, createdAt: new Date().toISOString(), fit: l.fit || "yield", template: l.template, hasPaper: l.hasPaper, artist: l.artist, refSet: l.refSet };

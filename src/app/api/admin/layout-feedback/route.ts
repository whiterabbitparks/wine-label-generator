...
import { addLayoutFeedback, layoutWeights, LAYOUT_STYLES, VARIANT_COUNTS } from "@/lib/admin/layout-refs";
...
export async function POST(req: Request) {
  ...
  await addLayoutFeedback({ style, variant, verdict: body.verdict, comment: String(body.comment || "").slice(0, 500) });

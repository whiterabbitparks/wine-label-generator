...
export const GUIDE: GuideStep[] = [
  ...
  { page: "vision", at: { x: 136, y: 342, w: 551, h: 207 }, side: "below",
    ...
    ge: "რამდენიმე სიტყვით აღწერე ეტიკეტის სურათი — ან დააჭირე „მომეცი იდეა“-ს. თუ ველს ცარიელს დატოვებ, მხატვარი თავის სტილში აბსტრაქციას დახატავს.", optional: true },
  { page: "vision", at: { x: 137, y: 275, w: 241, h: 34 }, side: "above",
    en: "Optional: upload a sketch or a photo to show what you mean.",
    ge: "სურვილისამებრ: ატვირთე ესკიზი ან ფოტო, რომ აჩვენო რა გინდა.", optional: true },
  ...
  { page: "loader", at: { x: 620, y: 592, w: 200, h: 4 }, side: "below",
    ...
    ge: "სამი მხატვარი ახლა ხატავს. დაახლოებით ერთი წუთი დასჭირდება.", done: "page:options", wait: true },
  /* ── front label ── */
  ...
  { page: "backdetails", at: { x: 137, y: 452, w: 550, h: 30 }, side: "above",
    ...
    ge: "გაქვს შტრიხკოდი? ჩაწერე მისი 12 ან 13 ციფრი. თუ არ გაქვს — დატოვე ცარიელი.", optional: true },
  { page: "backdetails", at: { x: 753, y: 450, w: 550, h: 34 }, side: "above",
    ...
    ge: "შექმენი QR კოდი და პროდუქტის ვებ-გვერდი — ან ატვირთე შენი QR კოდი, თუ გაქვს ასეთი.", optional: true },

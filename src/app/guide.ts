...
export const GUIDE: GuideStep[] = [
  ...
  { page: "vision", at: { x: 891, y: 262, w: 411, h: 395 }, side: "left",
    en: "Now the label's details. Type them exactly as they should print — capitals and language stay as you type them.",
    ge: "ახლა ეტიკეტის დეტალები. ჩაწერე ზუსტად ისე, როგორც უნდა დაიბეჭდოს — დიდი ასოები და ენა ისე დარჩება, როგორც ჩაწერ." },
  { page: "vision", at: { x: 891, y: 262, w: 411, h: 395 }, side: "left",
    en: "You don't have to fill every field. Anything you leave empty simply isn't on the label.",
    ge: "ყველა ველის შევსება აუცილებელი არ არის. რასაც ცარიელს დატოვებ, ეტიკეტზე უბრალოდ არ იქნება." },
  ...
  /* ── painting ── */
  { page: "loader", at: { x: 620, y: 300, w: 200, h: 220 }, side: "below",
  ...
  { page: "options", at: { x: 137, y: 290, w: 1166, h: 250 }, side: "above",
    en: "Three designs, each by a different artist. Click a label to see it big.",
    ge: "სამი დიზაინი, თითო სხვადასხვა მხატვრის. დააჭირე ეტიკეტს, რომ დიდად ნახო." },
  ...
  { page: "backdetails", at: { x: 136, y: 208, w: 551, h: 208 }, side: "below",
    ...
    ge: "რამდენიმე სტრიქონით აღწერე შენი ღვინო — ეს უკანა ეტიკეტზე დაიწერება." },
  { page: "backdetails", at: { x: 755, y: 200, w: 548, h: 215 }, side: "left",
    en: "The producer and bottling details. Fill in what you have — empty fields are left off.",
    ge: "მწარმოებლისა და ჩამოსხმის დეტალები. შეავსე რაც გაქვს — ცარიელი ველები არ დაიწერება." },
  ...
  { page: "backdetails", at: { x: 753, y: 450, w: 550, h: 34 }, side: "above",
    en: "A QR code can link to a page with your wine's ingredients. Create one, or upload your own.",
    ge: "QR კოდი შეიძლება ღვინის ინგრედიენტების გვერდზე მიდიოდეს. შექმენი, ან ატვირთე შენი." },
  ...
  { page: "bottle", at: { x: 342.9, y: 171.7, w: 960, h: 412 }, side: "below",
    en: "Choose the wine's colour, the bottle, its glass, the closure and the closure's colour — the photos will show exactly this.",
    ge: "აირჩიე ღვინის ფერი, ბოთლი, მინის ფერი, თავსახური და მისი ფერი — ფოტოებზე ზუსტად ეს გამოჩნდება." },
  ...
  { page: "bottle", at: { x: 350, y: 150, w: 740, h: 520 }, side: "right", modal: true,
    en: "Check your details. Create starts the photos; Edit Details takes you back.",
    ge: "გადაამოწმე დეტალები. Create იწყებს ფოტოებს; Edit Details უკან დაგაბრუნებს.", done: "page:assets" },
  /* ── marketing assets ── */
  ...
  /* ── final pack ── */
  { page: "checkout", at: { x: 137, y: 445, w: 481, h: 173 }, side: "right",
    en: "Your Final Pack. Tick what you need, agree to the terms, then press the red button to pay and download. That's the whole round — well done!",
    ge: "შენი საბოლოო პაკეტი. მონიშნე რაც გჭირდება, დაეთანხმე პირობებს და გადასახდელად და ჩამოსატვირთად დააჭირე წითელ ღილაკს. ეს იყო მთელი რაუნდი — ყოჩაღ!" },
];

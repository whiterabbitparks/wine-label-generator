...
export const UI_GE: Record<string, string> = {
  ...
  /* round 106: the card is one line of title and two of body */
  "Your Vision & front label details": "თქვენი ხედვა და წინა ეტიკეტის დეტალები",
  "Tell me what you picture, and the details": "მიამბეთ, რას წარმოიდგენთ, და რა დეტალები",
  "that belong on your front label.": "უნდა იყოს თქვენს წინა ეტიკეტზე.",
  "Front label": "წინა ეტიკეტი",
  "Voilà — three designs to choose from.": "აი — სამი დიზაინი ასარჩევად.",
  "Back label details, Barcode & QR code": "უკანა ეტიკეტის დეტალები, შტრიხკოდი და QR კოდი",
  "A few more details, and I'll build a back label": "კიდევ რამდენიმე დეტალი და შევქმნი უკანა ეტიკეტს,",
  "that meets your market's rules.": "რომელიც თქვენი ბაზრის წესებს დააკმაყოფილებს.",
  "Back label": "უკანა ეტიკეტი",
  "Done. Print-ready, and compliant with": "მზადაა. საბეჭდად მზა და შესაბამისი",
  "the markets you chose.": "იმ ბაზრებთან, რომლებიც აირჩიეთ.",
  "Bottle details": "ბოთლის დეტალები",
  "Tell me about the bottle and the closure, so I can": "მიამბეთ ბოთლსა და საცობზე, რომ გადავიღო",
  "photograph your wine exactly as it will look on the shelf.": "თქვენი ღვინო ისე, როგორც თაროზე გამოჩნდება.",
  "Marketing assets": "სამარკეტინგო მასალა",
  ...
  "the closure — I'll shoot it": "საცობზე — გადავიღებ ისე,",
  ...
  "About artists": "არტისტების შესახებ",
  "Next": "შემდეგი",
  "Finish": "დასრულება",
  "Download": "ჩამოტვირთვა",
